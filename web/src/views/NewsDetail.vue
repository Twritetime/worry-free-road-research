<template>
  <div class="page-container" v-loading="loading">
    ...
    <div class="detail-content" v-if="news.id">
      <div class="article-container">
         <div class="article-header">
            ...
            <div class="article-meta">
               ...
               <span class="meta-item"><el-icon><View /></el-icon> {{ news.viewCount || 0 }} 阅读</span>
               <span class="meta-separator">|</span>
               <span class="meta-item"><el-icon><ChatDotRound /></el-icon> {{ total || 0 }} 评论</span>
               <span class="meta-separator">|</span>
               <el-tag size="small" :type="getTypeTag(news.type)" effect="plain" round>{{ news.type }}</el-tag>
            </div>
         </div>
         ...
         <div class="article-footer">
            <div class="actions">
                ...
                <el-button round size="large" icon="Share" @click="handleShare">分享</el-button>
                <el-button round size="large" @click="$router.back()">返回列表</el-button>
            </div>
         </div>
      </div>
    ...
    <el-empty v-else-if="!loading" description="未找到资讯信息"></el-empty>
  </div>
</template>
...
import { Star, StarFilled, Calendar, View, ArrowRight, Share, ChatDotRound } from '@element-plus/icons-vue'
...
const checkIsFavorited = async (id) => {
    try {
...
const handleToggleFavorite = async () => {
    ...
    try {
        await toggleFavorite({
            ...
            targetType: 1, // 1 for News
            targetTitle: news.value.title,
            targetCover: news.value.coverImg
        })
